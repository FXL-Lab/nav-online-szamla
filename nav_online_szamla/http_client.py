...
from .config import (
    DEFAULT_HEADERS, DEFAULT_TIMEOUT, MAX_RETRY_ATTEMPTS,
    RETRY_BACKOFF_MULTIPLIER, RETRY_BACKOFF_MIN, RETRY_BACKOFF_MAX,
...
class NavHttpClient:
    ...
    def _make_request(self, method: str, url: str, headers: Optional[Dict[str, str]] = None, 
                     data: Optional[str] = None, params: Optional[Dict[str, Any]] = None) -> requests.Response:
        """
    ...
    def post(self, endpoint: str, data: str, headers: Optional[Dict[str, str]] = None) -> requests.Response:
        """
