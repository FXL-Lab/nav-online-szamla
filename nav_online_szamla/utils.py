...
def calculate_request_signature(request_id: str, timestamp: str, signer_key: str) -> str:
    """
...
def split_date_range(start_date: str, end_date: str, max_days: int = MAX_DATE_RANGE_DAYS) -> List[Tuple[str, str]]:
    """
...
def get_nested_xml_element_value(xml_doc: xml.dom.minidom.Document, xml_path: str) -> Optional[str]:
    """
