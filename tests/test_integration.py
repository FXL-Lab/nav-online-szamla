...
from nav_online_szamla import (
    ...
    QueryInvoiceDigestRequest, MandatoryQueryParams, AdditionalQueryParams,
    ...
    def test_date_range_splitting_example(self):
        ...
        request = QueryInvoiceDigestRequest(
            ...
            invoice_query_params=InvoiceQueryParams(
                mandatory_query_params=MandatoryQueryParams(
                    ins_date=DateTimeRange(
                        date_time_from=start_date,
                        date_time_to=end_date
                    )
                )
            )
        )
        ...
        assert request.invoice_query_params.mandatory_query_params.ins_date.date_time_from == start_date
        assert request.invoice_query_params.mandatory_query_params.ins_date.date_time_to == end_date
